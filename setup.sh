...
#install v2ray
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/install/install.sh && chmod +x install.sh && ./install.sh
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/install/bbr.sh && chmod +x bbr.sh && ./bbr.sh
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/install/ins-menu.sh && chmod +x ins-menu.sh && ./ins-menu.sh
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
cd
...
cd
wget https://raw.githubusercontent.com/myridwan/scssh/main/install/ipsec.sh && chmod +x ipsec.sh && ./ipsec.sh
cd
rm -f ssh-vpn.sh
rm -f ssr.sh
rm -f install.sh
